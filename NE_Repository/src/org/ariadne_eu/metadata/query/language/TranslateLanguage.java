...
/**
 * Created by ben Date: 5-mei-2007 Time: 17:16:30 To change this template use
...
public class TranslateLanguage {
	...
	public static String translateToQuery(String query, int startQueryLanguage,
			int endQueryLanguage, int startResult, int nbResults,
			int resultsFormat) throws QueryTranslationException {
		return getTranslateImplementation(startQueryLanguage, endQueryLanguage)
				.translateToQuery(query, startResult, nbResults, resultsFormat);
	}

	public static String translateToCount(String query, int startQueryLanguage,
			int endQueryLanguage) throws QueryTranslationException {
		return getTranslateImplementation(startQueryLanguage, endQueryLanguage)
				.translateToCount(query);
	}
	...
	public static int getQueryLanguage(String queryLanguage) {
		...
		if (queryLanguage.equalsIgnoreCase("vsql")) {
			...
			return PLQL0;
				...
				.equalsIgnoreCase("http://www.prolearn-project.org/PLQL/l0")) {
			return PLQL0;
		} else if (queryLanguage.equalsIgnoreCase("plql1")) {
			return PLQL1;
		} else if (queryLanguage
				.equalsIgnoreCase("http://www.prolearn-project.org/PLQL/l1")) {
			return PLQL1;
		} else if (queryLanguage.equalsIgnoreCase("plql2")) {
			return PLQL2;
		} else if (queryLanguage
				.equalsIgnoreCase("http://www.prolearn-project.org/PLQL/l2")) {
			return PLQL2;
	...
	private static Translate getTranslateImplementation(int startQueryLanguage,
			int endQueryLanguage) throws QueryTranslationException {
		if (cachedImplementations.get(new HashMapKey(startQueryLanguage,
				endQueryLanguage)) == null) {
			switch (endQueryLanguage) {
			case XQUERY:
				switch (startQueryLanguage) {
				case VSQL:
					cachedImplementations.put(new HashMapKey(
							startQueryLanguage, endQueryLanguage),
							new Vsql_XQueryHandler(startQueryLanguage,
									endQueryLanguage));
					break;
				case PLQL0:
					cachedImplementations.put(new HashMapKey(
							startQueryLanguage, endQueryLanguage),
							new Plql_XQueryHandler(startQueryLanguage,
									endQueryLanguage));
					break;
				case PLQL1:
					cachedImplementations.put(new HashMapKey(
			...
			case LUCENE:
				...
				case VSQL:
					cachedImplementations.put(new HashMapKey(
							startQueryLanguage, endQueryLanguage),
							new Vsql_LuceneHandler(startQueryLanguage,
									endQueryLanguage));
					break;
				case PLQL0:
					cachedImplementations.put(new HashMapKey(
							startQueryLanguage, endQueryLanguage),
							new Plql_LuceneHandler(startQueryLanguage,
									endQueryLanguage));
					break;
				case PLQL1:
					cachedImplementations.put(new HashMapKey(
				...
				case LUCENE:
					cachedImplementations.put(new HashMapKey(
							startQueryLanguage, endQueryLanguage),
							new LuceneHandler(startQueryLanguage,
									endQueryLanguage));
					break;
				case JSON:
					cachedImplementations.put(new HashMapKey(
							startQueryLanguage, endQueryLanguage),
							new Json_LuceneHandler(startQueryLanguage,
									endQueryLanguage));
					break;
				}
				break;
		...
		return (Translate) cachedImplementations.get(new HashMapKey(
				startQueryLanguage, endQueryLanguage));
	}
